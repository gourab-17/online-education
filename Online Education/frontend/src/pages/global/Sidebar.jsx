                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/courses" />} icon={<PlayLessonIcon />}> Courses </MenuItem>
                                        <MenuItem component={<Link to="/admin/category" />} icon={<CategoryIcon />}> Category </MenuItem>
                                        <MenuItem component={<Link to="/user/info" />} icon={<LockPersonIcon />}> Admin Profile </MenuItem>
                                    </> :
                                    <>
                                        <MenuItem component={<Link to="/user/dashboard" />} icon={<DashboardIcon />}> Dashboard </MenuItem>
                                        <MenuItem component={<Link to="/user/courses" />} icon={<BookmarksIcon />}> Bookmarked Courses </MenuItem>
