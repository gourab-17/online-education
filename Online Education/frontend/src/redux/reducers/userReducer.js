...
// apply for a course reducer
export const userApplyCourseReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_APPLY_COURSE_REQUEST:
            return { loading: true }
        case USER_APPLY_COURSE_SUCCESS:
            return {
                loading: false,
                userCourse: action.payload,
            }
        case USER_APPLY_COURSE_FAIL:
            return { loading: false, error: action.payload }
        case USER_APPLY_COURSE_RESET:
            return {}
        default:
            return state;
    }
