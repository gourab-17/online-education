...
export const USER_APPLY_COURSE_REQUEST = "USER_APPLY_COURSE_REQUEST";
export const USER_APPLY_COURSE_SUCCESS = "USER_APPLY_COURSE_SUCCESS";
export const USER_APPLY_COURSE_FAIL = "USER_APPLY_COURSE_FAIL";
export const USER_APPLY_COURSE_RESET = "USER_APPLY_COURSE_RESET";
